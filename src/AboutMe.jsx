...
const AboutMe = () => {
  return (
    <section id="aboutMe">
      <h2>About Me</h2>
      <p>
      ¡Hola! 👋 I'm Camila, a front-end development student hailing from the beautiful country of Costa Rica 🌴. Currently sharpening my skills at Centro de Tecnología y Artes Visuales (CETAV), I'm on a mission to create captivating web experiences.
